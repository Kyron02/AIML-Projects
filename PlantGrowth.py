...
def SVR():
    ...
    text.insert(END, 'Predictive Accuracy: ' + str(100 - (100 * mse)) + "\n")
    svr_mae = mae
    svr_mse = mse
    svr_rmse = rmse
...
font = ('times', 16, 'bold')
title = Label(main, text='PREDICTIVE MODELING FOR ENHANCED PLANT CULTIVATION IN GREENHOUSE ENVIRONMENTS')
...
font1 = ('times', 14, 'bold')
upload = Button(main, text="Upload Tomato Plant Dataset", command=upload)
